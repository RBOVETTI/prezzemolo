  ...
  return (
    <div className="min-h-screen bg-dark py-12">
      <div className="container mx-auto px-5 max-w-4xl">
        ...
        <div className="bg-dark-light rounded-lg p-8 text-text-muted space-y-6">
          ...
          <section>
            ...
            <h3 className="text-xl font-bold text-primary mb-2 mt-4">3.2 Finalità del trattamento</h3>
            ...
            <h3 className="text-xl font-bold text-primary mb-2 mt-4">3.3 Base giuridica del trattamento</h3>
            <p>
          ...
          <section>
            ...
            <div className="bg-dark p-4 rounded mt-4">
              <p className="font-bold text-primary mb-2">Come esercitare i tuoi diritti:</p>
              <p className="mb-2">
